...
TEST_F(FlowDbTest, BidirectionalFlow) {
    ...
    auto forward_tuple = create_test_tuple_ipv4("192.168.1.1", 80, "192.168.1.2", 8080);
    
    // Create reverse tuple (swapped IPs and ports)
    auto reverse_tuple = create_test_tuple_ipv4("192.168.1.2", 8080, "192.168.1.1", 80);
...
TEST_F(FlowDbTest, MultipleFlows) {
    ...
    auto tuple3 = create_test_tuple_ipv4("10.0.0.1", 22, "10.0.0.2", 2222, IPPROTO_UDP);
...
TEST_F(FlowDbTest, UdpFlow) {
    auto udp_tuple = create_test_tuple_ipv4("192.168.1.1", 53, "8.8.8.8", 53, IPPROTO_UDP);
