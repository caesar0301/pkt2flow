...
TEST_F(UtilitiesTest, NewFileNameIPv4WithVlan) {
    auto tuple = create_test_tuple_ipv4("10.0.0.1", 443, "10.0.0.2", 9090, IPPROTO_TCP, 1);
...
TEST_F(UtilitiesTest, NewFileNameIPv6WithVlan) {
    auto tuple = create_test_tuple_ipv6("fe80::1", 22, "fe80::2", 2222, IPPROTO_TCP, 1);
...
TEST_F(UtilitiesTest, NewFileNameZeroPorts) {
    auto tuple = create_test_tuple_ipv4("172.16.0.1", 0, "172.16.0.2", 0, IPPROTO_UDP);
